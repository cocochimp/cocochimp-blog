...
<div class="">
			...
			<el-col :span="24">
				...
				<div class="headBox">
					<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
						...
						<!-- <el-menu-item index="/Reward"><i class="fa fa-wa fa-cny"></i> (代办)</el-menu-item> -->
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(https://cocochimp-markdown-img.oss-cn-beijing.aliyuncs.com/save/bg-5ae3caa.jpg)'}">
		<div class="scene">
			<div><span id="luke"></span></div>
		</div>
		<div class="h-information">

                    <img :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:'https://cocochimp-markdown-img.oss-cn-beijing.aliyuncs.com/save/头像啊啊啊.jpg'" alt="">

			<h2 class="h-description">

                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"To be a cool man"}}
...
export default {
	data() { //选项 / 数据
		return {
			...
			// path:'',//当前打开页面的路径
			input: '', //input输入内容
			headBg: 'url(https://cocochimp-markdown-img.oss-cn-beijing.aliyuncs.com/save/bg-7a1803e.jpg)', //头部背景图
			headTou: '', //头像
			projectList: '' //项目列表
		}
	},
