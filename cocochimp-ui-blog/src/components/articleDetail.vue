...
<template>
        <div class="detailBox tcommonBox" >
            ...
            <div class="article-content markdown-body" v-html="detailObj.content" v-lazy-container="{ selector: 'img'}" ></div>
        ...
        methods: { //事件处理器
            ...
            getArticleDetail:function(){
                getArticle(this.aid).then((response)=>{
                    ...
                    this.detailObj.content=this.detailObj.content.replace(/src/g, 'data-src')
                })
            },
