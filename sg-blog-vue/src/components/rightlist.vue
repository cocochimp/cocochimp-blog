...
<template>
  <div class="rightlistBox">
        ...
        <img
          :src="
            this.$store.state.themeObj.center_smailimg
              ? this.$store.state.themeObj.center_smailimg
              : 'https://cocochimp-markdown-img.oss-cn-beijing.aliyuncs.com/save/看热闹.jpg'
          "
          alt=""
        />
    ...
    <section class="rs4">
     <a href="https://beian.miit.gov.cn/" class="footer">
      <img src="../assets/img/badge.png" alt="">闽ICP备2023004125号
     </a>
    </section>
    <!-- 右侧上滑小图片 -->
    <div
...
export default {
  data() {
    ...
    return {
      ...
      catchMeObj: {
        //个人信息
        git: "https://gitee.com/cocochimp",
        qq: "/static/img/QQ扫码.jpg",
        //sina: "https://weibo.com",
        wechat: "/static/img/微信扫码.jpg",
        csdn: "https://blog.csdn.net/m0_51634403?type=blog",
